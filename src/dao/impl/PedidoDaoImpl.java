	  ...
	  @Override
	    public List<Pedido> listPedidos() {
	        ...
	        try {
	            ...
	            String sql = "SELECT IdPedido, SalaId, NumeroMesa, Fecha, Total, Estado, Usuario FROM Pedido";
	    ...
	    public Pedido getPedido(int id) {
	        ...
	        try {
	            cn = MySqlConexion.getConexion();
	            String sql = "SELECT IdPedido, SalaId, NumeroMesa, Fecha, Total, Estado, Usuario FROM Pedido WHERE IdPedido = ?";
